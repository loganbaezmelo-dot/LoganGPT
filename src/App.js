...
function App() {
  ...
  const [showCommands, setShowCommands] = useState(false); // CONTROLS THE MENU
  ...
  const handleInputChange = (e) => {
    ...
    // Only show menu if user types EXACTLY "/" and is not already searching
    if (val === "/" && !isSearchMode) {
    ...
    <div className="app-container">
      ...
      <div className="main-content">
        ...
        <div className="input-area">
          {/* COMMAND MENU (Only shows if showCommands is true) */}
          {showCommands && (
